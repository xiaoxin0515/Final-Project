...
next_point = [0, 0]  # Best next move

ratio = 1  # offensive coefficient. If it is greater than 1, means offensive playstyle. If it is less than 1, means defensive playstyle.
DEPTH = 3  # search depth, 3 is enough for a not-bad AI.
...
def ai():
    ...
    print("Prunning number of this time:" + str(cut_count))
    print("Searching number of this time:" + str(search_count))
...
def main():
    ...
    while g == 0:
        ...
        if change % 2 == 1:
            ...
            if pos in list3:
                message = Text(Point(200, 200), "Unusable location" + str(pos[0]) + "," + str(pos[1]))
                message.draw(win)
                g = 1
